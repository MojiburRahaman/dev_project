    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="form-layout">
                <form action="general-add-post.php" method="POST" enctype="multipart/form-data">
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <img id="logo_img" style="width: 150px;">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label class="form-control-label" for="copyright" >Copyright: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="copyright"  id="copyright"  type="text">
                            </div>
                        </div>
                    </div>
