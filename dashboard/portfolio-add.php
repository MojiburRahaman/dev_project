    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="form-layout">
                <form action="portfolio-add-post.php" method="POST" enctype="multipart/form-data">
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="catagory" placeholder="Enter Tagline" name="catagory">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <img id="thumbnail_img" style="width: 150px;"">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <img id="featured_img" style="width: 150px;"">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="form-group">
